...
toolbox.router.get(/^https:\/\/pieman-d47da\.firebaseio\.com\/pietime.json/, toolbox.fastest, {"cache":{"name":"pietime"}});
toolbox.router.get(/https:\/\/www\.reddit\.com\/r\/\w{1,255}\.json/, toolbox.networkFirst, {"cache":{"name":"titles"}});




importScripts("js/caching.js","lib/firebase/firebase.js","js/FCMScript.js","lib/localforage/dist/localforage.js","js/sync.js");
